...
<div style={{paddingLeft:'60ch', marginTop:'-74ch'}}>
    <label style={{fontSize:'26px'}}>Coin contracts </label>
       ...
       <br/>
            ...
            <img style={{width:'3.6ch',marginTop:'-4.2px' ,marginLeft:'0px', border:"3px solid #ccc" ,borderRight:'none'}}src="https://www.worldcryptoindex.com/wp-content/uploads/2018/01/binance-coin-logo.png"></img>
        ...
        <img style={ {width:'3.6ch',marginTop:'-4.2px' ,marginLeft:'0px', border:"3px solid #ccc" ,borderRight:'none'}} src="https://res.cloudinary.com/crunchbase-production/image/upload/c_lpad,h_256,w_256,f_auto,q_auto:eco,dpr_1/v1476103033/xfu7exy5y6rkscsm1kns.png"></img>
        ...
        <img style={{width:'3.6ch',marginTop:'-4.2px' ,marginLeft:'0px', border:"3px solid #ccc" ,borderRight:'none'}} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSunIhUvL83iGZbs4UAExq_qChqGlJTlH9IB45nYgAc_jTI4Mug-l-AWodcw5MhgY37GO8&usqp=CAU"></img>
...
<label style={{fontSize:'26px'}}> Coin Links </label>
        ...
        <img style={{width:'3.6ch',marginTop:'-4.2px' ,marginLeft:'0px', border:"3px solid #ccc" ,borderRight:'none'}} src="https://cdn-icons-png.flaticon.com/128/93/93618.png"></img>
        ...
        <img style={{width:'3.6ch',marginTop:'-4.2px' ,marginLeft:'0px', border:"3px solid #ccc" ,borderRight:'none'}}
        ...
        <img style={{width:'3.8ch' ,marginLeft:'0px',marginTop:'-3px', border:"3px solid #ccc"}}
        ...
        style={{ marginLeft:'-2px',paddingLeft:'10px',marginTop:'13px',width:'40ch',height:'4ch', border:"3px solid #ccc", borderRadius:'4px',borderLeft:'none'}}
